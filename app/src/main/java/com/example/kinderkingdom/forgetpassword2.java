...
public class forgetpassword2 extends AppCompatActivity {
    ...
    public void continuee(View view) {
        ...
        Intent continuee=new Intent(forgetpassword2.this, welcomeepage.class);
    ...
    public void searchbyphone(View view) {
        ...
        Intent searchbyphone =new Intent(forgetpassword2.this, forgetpassword1.class);
        startActivity(searchbyphone);
    }
