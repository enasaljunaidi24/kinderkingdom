...
public class studentmychild extends AppCompatActivity {
    ...
    public void information(View view) {
        if (isVoiceEnabled()) speaker.speak("Information");
        Intent studentinformationpage = new Intent(studentmychild.this, studentsinformationofteachers.class);
    ...
    public void teachersinformation(View view) {
        ...
        Intent teachersinformation =new Intent(studentmychild.this, teacherinformationofstudents.class);
    ...
    public void RegistrationandPayment(View view) {
        if (isVoiceEnabled()) speaker.speak("Registration and Payment");
