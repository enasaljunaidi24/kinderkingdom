...
public class classschedule extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_classschedule,container,false);
        buttonschedule = root.findViewById(R.id.classschedule2);
         buttonmarks = root.findViewById(R.id.marks2);
        return root;
    }
}